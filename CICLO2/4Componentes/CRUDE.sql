CREATE OR REPLACE PACKAGE PC_FUNCIONESEXCLUSIVAS AS
    ---Clientes Aprendizajes
    PROCEDURE AD_ClienteAprendizaje(p_usuario IN NUMBER, p_idAprendizaje IN NUMBER);
    PROCEDURE DE_ClienteAprendizaje(p_usuario IN NUMBER, p_idAprendizaje IN NUMBER);
    PROCEDURE DE_ClienteAprendizajeusuario(p_usuario IN NUMBER);
    PROCEDURE DE_ClienteAprendizajeid(p_idAprendizaje IN NUMBER);
    FUNCTION  CO_ClienteAprendizajeUsuario(p_usuario IN NUMBER) RETURN SYS_REFCURSOR;
    FUNCTION  CO_ClienteAprendizaje(p_idAprendizaje IN NUMBER) RETURN SYS_REFCURSOR;
    ---AprendizajeGrupal
...
CREATE OR REPLACE PACKAGE PC_HORARIOS AS
